package com.sjl.core.widget.imageview;
 ...
 * @author Kelly
 * @version 1.0.0
 * @filename CustomRoundAngleImageView.java
 * @time 2018/12/21 17:07
...
public class CustomRoundAngleImageView extends AppCompatImageView {
    ...
    //onDraw()方法中进行了宽度和高度判断，判断的依据是用户设置的角度值的和是小于等于ImageView的宽度或高度的
    @Override
