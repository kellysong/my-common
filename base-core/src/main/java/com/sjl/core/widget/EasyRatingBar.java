...
public class EasyRatingBar extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mInterval = (int) a.getDimension(R.styleable.EasyRatingBar_rateInterval, ViewUtils.dp2px(mContext, 4));
    ...
    private int getInitRoomHeight() {
        ...
        return Math.min(ViewUtils.dp2px(mContext, DEFAULT_MAX_HEIGHT), drawableMin);
    }
